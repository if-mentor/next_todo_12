import {Button, Box, Flex, Icon, FormLabel, Input, Textarea } from "@chakra-ui/react";
...
export default function Home() {
    return (
        <Box position="relative">
            <header>
                <Box bg="#68D391">
                    <Flex w="80%" p="1% 0" m="0 auto" justifyContent="space-between" alignItems="center" fontWeight="bold">
            ...
            <main>
                <Flex className="button-flex" w="80%" m="1% auto" justifyContent="flex-end" gap="1%">
                    <Button color="#fff" bg="#25855A" border="1px solid #333" rounded="full" fontSize="18px">Comment</Button>
                    <Button color="#333" bg="#68D391" border="1px solid #333" rounded="full" fontSize="18px">Back</Button>
                </Flex>
                <Flex className="show-wrapper" w="80%" m="1% auto" gap="2%" alignItems="end">
                    <Box className="todo-wrapper" p="1%" w="49%" border="1px solid #333" rounded="10">
            ...
            {/* モーダルについて */}
            <Box w="100vw" h="100vh" bg="#000" opacity=".3" position="absolute" top="0" left="0">
            </Box>
            <Box zIndex="100" position="absolute" top="50%" left="50%" transform="translate(-50%, -50%)" bg="#fff" p="1%" border="1px solid #333" rounded="10px">
                ...
                <Button color="#fff" bg="#25855A" border="1px solid #333" rounded="10px" fontSize="18px" w="100%">CREATE</Button>
            </Box>
        </Box>
    )
}